...
{{- define "chart-wrapper.onlineWatchAppLabel" -}}
{{- $onlineWatch := (get (.Values.ressuite | default dict) "online-watch-be") | default dict -}}
{{- default "online-watch-be" (get $onlineWatch "appLabel") -}}
{{- end -}}
